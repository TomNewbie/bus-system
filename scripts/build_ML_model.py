...
# -- Load file --
FILE_PATH = "backend/prediction_model_lstm/dataset/pre_processed_data.csv"
...
model = keras.Sequential([
    keras.layers.LSTM(50, activation='relu', return_sequences=True, input_shape=(seq_length, X_seq.shape[2])),
